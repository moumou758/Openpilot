...
CAPNP_DECLARE_SCHEMA(ecf44c90b29f6e5e);
enum class MpcSource_ecf44c90b29f6e5e: uint16_t {
  ACC,
  BLENDED,
};
CAPNP_DECLARE_ENUM(MpcSource, ecf44c90b29f6e5e);
...
struct LongitudinalPlanSP {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::MpcSource_ecf44c90b29f6e5e MpcSource;
...
public:
  ...
  inline  ::cereal::LongitudinalPlanSP::MpcSource getMpcSource() const;
...
public:
  ...
  inline  ::cereal::LongitudinalPlanSP::MpcSource getMpcSource();
  inline void setMpcSource( ::cereal::LongitudinalPlanSP::MpcSource value);
...
inline  ::cereal::LongitudinalPlanSP::MpcSource LongitudinalPlanSP::Reader::getMpcSource() const {
  return _reader.getDataField< ::cereal::LongitudinalPlanSP::MpcSource>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::cereal::LongitudinalPlanSP::MpcSource LongitudinalPlanSP::Builder::getMpcSource() {
  return _builder.getDataField< ::cereal::LongitudinalPlanSP::MpcSource>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void LongitudinalPlanSP::Builder::setMpcSource( ::cereal::LongitudinalPlanSP::MpcSource value) {
  _builder.setDataField< ::cereal::LongitudinalPlanSP::MpcSource>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}
